...
SERVICE_NAME = "onboarding-relevance-fresh-09"
PEERS: tuple[Peer, ...] = (
    Peer("avior-test-ob-org/onboarding-relevance-fresh-10", "FRESH_10_URL"),
    Peer("avior-test-ob-org/onboarding-relevance-fresh-11", "FRESH_11_URL"),
)
